        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Test Result</h3>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                   ...
                   <form method="post" action="online_test_result.php">
...
?>
                      ...
                      <select class="form-control" id="exam" placeholder="Exam Name" name="exam">
                          <option>Select Semester</option>
                        <!--   <?php
...
$query= " SELECT *
FROM student_reg
, exam_result where student_reg.stud_id=exam_result.stud_id and exam_result.semester='$semester' and exam_result.batch_id='$id' and exam_result.subject='$subject'and exam_result.exam_title='$exam' ";
$res=$con->query($query);
$count=$res->num_rows;
                      ...
                      <tbody>
                        <tr>
                         ...
                         <!--  <td> <?php echo $row['semester'];?></td>
                          ...
                          <td>
                             <?php echo $row['no_of_correct_answer'];?> 
                          </td>
