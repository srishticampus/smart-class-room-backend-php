...
if($msg=="success"){
    ...
    $message = '<div class="alert alert-danger"> Subject deleted Failed.</div>';
}
@session_start();
$id=$_SESSION['log'];
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                   ...
                   <form method="post" action="view_subject.php">
...
$id=$_POST['id'];
$fac=$ro['faculty_id'];
$query= "select * from `semester_subject` where semester='$semester' and batch_id='$id'  ";
$res=$con->query($query);
$count=$res->num_rows;
...
while($row=$res->fetch_assoc()){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <img src="<?php echo $row['file'];?>" style="width: 70px;height: 50px;">
                          </td>
                         
                          
                          <td><a href="delete_subject.php?id=<?php echo $row['sub_id'];?>"><i class="fa fa-trash-o" style="font-size:20px;color:red"></i></a></td>
 ...
 <script type="text/javascript">
         ...
         window.history.replaceState({}, document.title, "/" + "projects/College/view_subject.php");
     </script>
    <script type="text/javascript">
